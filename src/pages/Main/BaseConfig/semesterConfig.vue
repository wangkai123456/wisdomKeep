...
<template>
  <div class="box">
    <header-tit img="semT.png" tit="学期管理" />
    <div class="top">
      <div class="add">
    ...
    >
      ...
      <el-table-column label="学期配置" prop="name"></el-table-column>
    ...
    <el-dialog title="新增学期配置"  :visible.sync="diaLog">
      <el-form v-if="ruleForm" :model="ruleForm" :rules="rules" ref="ruleForm">
        <el-form-item label="学期配置" >
          <el-input v-model="ruleForm.name" placeholder="请输入学期配置"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  data () {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "请输入学期配置", trigger: "change" }
        ]
      }
    }
  },
