<template>
  <div class="box">
    <header-tit img="culT.png" tit="栏目管理"/>
    <div class="top">
      <div class="add">
    ...
    >
      ...
      <el-table-column label="栏目配置" prop="name"></el-table-column>
    ...
    <el-dialog title="新增栏目"  :visible.sync="diaLog">
      <el-form v-if="ruleForm" :model="ruleForm" :rules="rules" ref="ruleForm">
        <el-form-item label="栏目配置" >
          <el-input v-model="ruleForm.name" placeholder="栏目配置"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  data () {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "请输入栏目配置", trigger: "change" }
        ]
      }
    }
  },
